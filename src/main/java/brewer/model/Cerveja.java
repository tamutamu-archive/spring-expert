...
public class Cerveja {
	...
	/**
	@Pattern(regexp = "([a-zA-Z]{2}\\d{4})?", message = "O padrão deve seguir 2 letras e 4 número. Ex: XX1234") //Duas letras e  Digitos
	*/ 
	...
	@DecimalMin("0.01")
	@DecimalMax(value = "9999999.99", message = "O valor da cervea deve ser menor que R$ 9.999.999,99")
	...
	@NotNull(message = "O percentual da comissão é obrigatório")
	@DecimalMax(value = "100.0", message = "A comissão deve ser igual ou menor que 100")
	private BigDecimal comissao; 
	
	@NotNull(message = "A quantidade em estoque é obrigatória")
	@Max(value = 9999, message = "A quantidade máxima em estoque deve ser menor que 9.999")
