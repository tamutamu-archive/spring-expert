/* Neste caso não declara um novo Brewer 
 * pois precisa do objeto Brewer do AutoComplete 
 */
...
Brewer.TabelaItens = (function () {
	...
	TabelaItens.prototype.iniciar = function() {
		/* Capturando o evento 'item-selecionado' do venda.auto-complete.js */
	...
	function onDoubleClick(evento) {
		$(this).toggleClass('solicitando-exclusao'); /* Neste caso o $(this) é igual a 'evento.currentTarget' */
	}
